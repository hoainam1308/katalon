...
WebUI.click(findTestObject('Object Repository/Page_E-LEARNING HUTECH  elearning - i Hc Cn_f0801a/input_Ti khon_eid'))
...
WebUI.click(findTestObject('Object Repository/Page_E-LEARNING HUTECH  My Workspace  Trang ch/span_H s'))
